...
ask_number('How many people? ')
  .then(([n_people, _]) => { return ask_number('How many pizzas do you have? ', [n_people]) })
  .then(([n_pizza, [n_people]]) => { return ask_even_number('How many pieces in a pizza? ', [n_people, n_pizza]); })
  .then(([n_piece, [n_people, n_pizza]]) => { 
